...
export type GetAllTweetsQuery = { getTweets: Array<{ id: string, content: string, imgUrl: string | null, author: { id: string, firstName: string, lastName: string | null, profileImgUrl: string | null } | null }> };
...
export type GetCurrentUserQuery = { getcurrentUser: { id: string, email: string, firstName: string, lastName: string | null, profileImgUrl: string | null, tweets: Array<{ id: string, content: string, author: { id: string, firstName: string, lastName: string | null, profileImgUrl: string | null } | null } | null> | null } | null };
...
export type GetUserByIdQuery = { getUserByID: { id: string, lastName: string | null, firstName: string, email: string, profileImgUrl: string | null, tweets: Array<{ id: string, content: string, imgUrl: string | null, author: { id: string, firstName: string, lastName: string | null, profileImgUrl: string | null } | null } | null> | null } | null };
